...
#############
#https://support.bioconductor.org/p/120724/
...
# FilesName = "path/to/your/file"

RVersion = "20210304V1"
dir.create(paste0(FilesName,RVersion))

## Load files
######### csv檔若是經由Excel整理會有基因名稱被錯誤轉換的問題! ##########
# Build # expression_matrix
data <- read.csv(paste0(FilesName,"GSE129455_Fibroblast-enriched.csv"),  # 資料檔名 
...
png(paste0(FilesName,RVersion,"/",RVersion,"_","PCA.png"), width = 640, height = 360) # 設定輸出圖檔
...
png(paste0(FilesName,RVersion,"/",RVersion,"_","tSNE.png"), width = 640, height = 360) # 設定輸出圖檔
...
# png(paste0(FilesName,RVersion,"/",RVersion,"_","tSNE_iCAF.png"), width = 640, height = 360) # 設定輸出圖檔
# plot_cells(cds, genes=iCAF_Main,reduction_method = c( "tSNE"))
# dev.off() # 關閉輸出圖檔
# 
# png(paste0(FilesName,RVersion,"/",RVersion,"_","tSNE_apCAF.png"), width = 640, height = 360) # 設定輸出圖檔
# plot_cells(cds, genes=apCAF_Main,reduction_method = c( "tSNE"))
# dev.off() # 關閉輸出圖檔
# 
# png(paste0(FilesName,RVersion,"/",RVersion,"_","tSNE_myCAF.png"), width = 640, height = 360) # 設定輸出圖檔
# plot_cells(cds, genes=myCAF_Main,reduction_method = c( "tSNE"))
# dev.off() # 關閉輸出圖檔
# 
# png(paste0(FilesName,RVersion,"/",RVersion,"_","myCAF_Cd248.png"), width = 640, height = 360) # 設定輸出圖檔
...
png(paste0(FilesName,RVersion,"/",RVersion,"_","myCAF_clusterK5.png"), width = 640, height = 360) # 設定輸出圖檔
...
png(paste0(FilesName,RVersion,"/",RVersion,"_","UMAP.png"), width = 640, height = 360) # 設定輸出圖檔
plot_cells(cds)
dev.off() # 關閉輸出圖檔
...
png(paste0(FilesName,RVersion,"/",RVersion,"_","UMAP_iCAF.png"), width = 640, height = 360) # 設定輸出圖檔
plot_cells(cds, genes=iCAF_Main)
dev.off() # 關閉輸出圖檔

png(paste0(FilesName,RVersion,"/",RVersion,"_","UMAP_apCAF.png"), width = 640, height = 360) # 設定輸出圖檔
plot_cells(cds, genes=apCAF_Main)
dev.off() # 關閉輸出圖檔

png(paste0(FilesName,RVersion,"/",RVersion,"_","UMAP_myCAF.png"), width = 640, height = 360) # 設定輸出圖檔
plot_cells(cds, genes=myCAF_Main)
dev.off() # 關閉輸出圖檔

png(paste0(FilesName,RVersion,"/",RVersion,"_","UMAP_Cd248.png"), width = 640, height = 360) # 設定輸出圖檔
plot_cells(cds, genes=CD248,cell_size = 1)
dev.off() # 關閉輸出圖檔
...
png(paste0(FilesName,RVersion,"/",RVersion,"_","UMAP_clusterK6.png"), width = 640, height = 360) # 設定輸出圖檔
...
# plot_cells(cds_subset, genes=iCAF_Main,reduction_method = c( "tSNE"))
# plot_cells(cds_subset, genes=apCAF_Main,reduction_method = c( "tSNE"))
# plot_cells(cds_subset, genes=myCAF_Main,reduction_method = c( "tSNE"))
# plot_cells(cds_subset, genes=CD248,reduction_method = c( "tSNE"),cell_size = 1)




# colData(cds_subset)$assigned_cell_type <- as.character(clusters(cds_subset)[colnames(cds_subset)])
# #plot_cells(cds_subset, color_cells_by="assigned_cell_type",reduction_method = c( "tSNE"),cell_size = 2,group_label_size = 5)
# 
